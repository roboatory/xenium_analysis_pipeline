...
# Dask config must run before any import that pulls in dask (e.g. src → spatialdata).
import dask.config
...
from src import analysis, io, plotting, preprocessing  # noqa: E402
...
def main() -> None:
    ...
    io.write_spatialdata_zarr(spatial_data, annotated_data, configuration, "processed")
